...
\newcommand{\figfile}[2]{%
  ...
  \IfFileExists{../research_log/figures/#1}{%
    \includegraphics[width=#2]{../research_log/figures/#1}%
  }{%
...
\begin{figure}[t]
\centering
\figfile{axis_severity/431_tooth0.png}{0.95\linewidth}
...
\begin{figure}[t]
\centering
\figfile{axis_severity/622_tooth0.png}{0.95\linewidth}
...
\begin{figure}[t]
\centering
\figfile{real_inset_test_431.jpg}{0.95\linewidth}\\[2pt]
\figfile{grace_qa_test_431.jpg}{0.95\linewidth}
\caption{Qualitative test example (image 431). Top: YOLO detection with per-tooth keypoint overlay at ROI inference. Bottom: grace-radius QA view showing expert clicks, their assigned tooth masks, and the region-growing ring that recovered out-of-mask clicks.}
...
\textbf{Future work:} (1) authorized evaluation on 214 clinician-annotated IOPAs; (2) YOLO refinement or GT-box distillation; (3) intersection-specific architecture or loss; (4) prospective comparison of axis methods in multi-center study; (5) a clinical reader study to score inter-reader agreement of the axis-constrained severity definitions.
