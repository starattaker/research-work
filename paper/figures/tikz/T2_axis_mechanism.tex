...
\node[note,anchor=north west,text=ink,text width=175mm] at (-0.35,-3.55)
  {\textbf{Measured consequence.}\ \ Injecting isotropic Gaussian noise of known $\sigma$ into
   ground-truth landmarks and re-measuring against each formula's own clean value
   ...
   margin widens monotonically --- $+0.005$ at $\sigma{=}4$\,px, $+0.024$ at $8$\,px,
   $+0.061$ at $16$\,px, $+0.063$ at $24$\,px.};
